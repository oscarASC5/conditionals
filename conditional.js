...
// third command line argument when calling 'node conditional.js'
 ...
 Otherwise, console.log("Create a Username");
...
var money =100
var item = "Create "
If (item) is (Jacket), -40 (money) +20 (health), console.log("You brought a jacket");
Else (item) is (candy), -10 (money) (console.log("You brought candy"));
Else (item) is (paint), -30 (money) (console.log("You bought paint"))
If (item) is (hammer), -70 (money) (console.log("You bought a hammer"));
